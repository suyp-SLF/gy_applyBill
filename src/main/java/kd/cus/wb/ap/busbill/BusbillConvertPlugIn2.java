...
public class BusbillConvertPlugIn2 extends AbstractConvertPlugIn {
...
//    }
    ...
    public void afterConvert(AfterConvertEventArgs e) {
    	...
    	String srcname = srcMainType.getName();
    	// 目标单主实体
        BillEntityType tgtMainType = this.getTgtMainType();
...
//            dataEntity.set("exchangerate", dataEntity.getString("exchangerate"));
