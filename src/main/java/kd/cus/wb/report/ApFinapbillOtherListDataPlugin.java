...
public class ApFinapbillOtherListDataPlugin extends AbstractReportListDataPlugin {
    ...
    public DataSet query(ReportQueryParam reportQueryParam, Object o) throws Throwable {
        ...
        String supplier = qfilter.getString("bfgy_supplier");
        ...
        qFilters[0] = new QFilter("billtype.number",QCP.equals,"WBApFin_other_BT_S_02");

        if (StringUtils.isNotBlank(pjtext)){
            qFilters[1] = new QFilter("bfgy_basedataxm.name", QCP.like, "%"+pjtext+"%");
        }
        ...
        if(StringUtils.isNotBlank(supplier)){
            qFilters[3] = new QFilter("asstact.name",QCP.like,"%"+supplier+"%");
        }
