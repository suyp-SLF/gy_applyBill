 ...
 * 	应收账款账龄分析表
 */
public class ReceivableageReportFormPlugin extends AbstractReportFormPlugin implements HyperLinkClickListener {
    @Override
