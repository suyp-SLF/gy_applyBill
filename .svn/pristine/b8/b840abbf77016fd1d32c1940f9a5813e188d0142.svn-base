...
public class ReceivableageListDataPlugin extends AbstractReportListDataPlugin {
    ...
    public DataSet query(ReportQueryParam reportQueryParam, Object o) throws Throwable {
        ...
        qFilters[0] = new QFilter("billtype.number",QCP.equals,"WBarfin_standard_BT_S_01");
